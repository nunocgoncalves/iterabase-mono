...
8. Delete the established pool's share-manager and prove fail-closed scheduling removal, a durable replacement-pending marker, preserved claim identity and desired replica count, backend/share-manager health before controller-owned replacement, and recovery only through two fresh workers.
