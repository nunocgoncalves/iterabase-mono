...
| `REQ-FND-INF-016` | Numerical/serving-semantic correctness and selection authority are separate from candidate; candidate cannot decide. | Reference tolerances and correctness/serving gates. |
