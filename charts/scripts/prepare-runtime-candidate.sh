...
candidate_chart=${2:?candidate chart name is required}
metadata="$candidate_dir/candidate-chart-$candidate_chart.json"
checksums="$candidate_dir/checksums-$candidate_chart.txt"
