...
DASHBOARDS = [
    ...
    ("iterabase-data-storage", "50 — Data and Storage", [
        ...
        ("Workspace free bytes", 'min by (pod) (control_plane_harness_workspace_free_bytes{namespace=~"$namespace"})', "bytes", "stat"),
        ("Workspace free ratio", 'min by (pod) (control_plane_harness_workspace_free_ratio{namespace=~"$namespace"})', "percentunit", "stat"),
        ("Workspace capacity warnings", 'sum(control_plane_harness_workspace_capacity_warning{namespace=~"$namespace"})', "short", "stat"),
        ("Workspace credit gates", 'sum(control_plane_harness_workspace_credit_gated{namespace=~"$namespace"})', "short", "stat"),
